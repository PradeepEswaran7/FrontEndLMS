...
const Carousel = () => {
  ...
  const items = [
    ...
    <div className="item" key="1" data-value="1"  >
      <div className="card-header" >
        <CardGroup>
          <Card style={{borderRadius:'50px',padding:'20px',border:'none',backgroundColor:'#f0f0f0'}}>
  ...
  return (
    <div className="carousel-container pb-2"  >
      <ReactCarousel
        showThumbs={false}
        showStatus={false}
        infiniteLoop
...
const HCourse = () => {
  return (
    <div className="container-fluid px-5 py-0 mt-1 healthy " style={{backgroundColor:'#f0f0f0'}}>
      <h5 className="text-center display-6 pt-2 fw-bold ">
        <center>Trending Courses</center>
      </h5>
 {/* <center>
<div class="marquee-container">
    <h5 class="marquee-text left">Your Marquee</h5>
    <h5 class="marquee-text right">Text Goes Here</h5>
  </div>
  </center> */}
